...
> = z.object({
  ...
  StartAuthSessionRecorderRequest:
    components.StartAuthSessionRecorderRequest$inboundSchema,
}).transform((v) => {
  return remap$(v, {
...
export type StartAuthSessionRecorderRequest$Outbound = {
  projectName: string;
  StartAuthSessionRecorderRequest:
    components.StartAuthSessionRecorderRequest$Outbound;
};
...
> = z.object({
  projectName: z.string(),
  startAuthSessionRecorderRequest:
    components.StartAuthSessionRecorderRequest$outboundSchema,
}).transform((v) => {
  return remap$(v, {
    startAuthSessionRecorderRequest: "StartAuthSessionRecorderRequest",
  });
