...
export function deleteAuthSessionGlobalsToJSON(
  deleteAuthSessionGlobals: DeleteAuthSessionGlobals,
): string {
  return JSON.stringify(
    DeleteAuthSessionGlobals$outboundSchema.parse(deleteAuthSessionGlobals),
  );
}

export function deleteAuthSessionGlobalsFromJSON(
  jsonString: string,
): SafeParseResult<DeleteAuthSessionGlobals, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeleteAuthSessionGlobals$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeleteAuthSessionGlobals' from JSON`,
  );
}
...
export function deleteAuthSessionRequestFromJSON(
  jsonString: string,
): SafeParseResult<DeleteAuthSessionRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DeleteAuthSessionRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DeleteAuthSessionRequest' from JSON`,
  );
}
