...
export namespace PdfFileType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PdfFileType> = z.nativeEnum(PdfFileType);
    export const outboundSchema: z.ZodNativeEnum<typeof PdfFileType> = inboundSchema;
}
