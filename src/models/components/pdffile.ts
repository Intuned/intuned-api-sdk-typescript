...
/** @internal */
export const PdfFileType$inboundSchema: z.ZodNativeEnum<typeof PdfFileType> = z
  .nativeEnum(PdfFileType);
...
/** @internal */
export const PdfFile$inboundSchema: z.ZodType<PdfFile, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const PdfFile$outboundSchema: z.ZodType<
  PdfFile$Outbound,
  z.ZodTypeDef,
  PdfFile
> = z.object({
