...
/** @internal */
export const JobPayload$inboundSchema: z.ZodType<JobPayload, z.ZodTypeDef, unknown> = z.object({
    apiName: z.string(),
...
/** @internal */
export const JobPayload$outboundSchema: z.ZodType<JobPayload$Outbound, z.ZodTypeDef, JobPayload> =
    z.object({
        apiName: z.string(),
