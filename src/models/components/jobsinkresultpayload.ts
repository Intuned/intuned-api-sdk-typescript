...
/** @internal */
export const ProjectJob$inboundSchema: z.ZodType<
  ProjectJob,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ProjectJob$outboundSchema: z.ZodType<
  ProjectJob$Outbound,
  z.ZodTypeDef,
  ProjectJob
> = z.object({
...
/** @internal */
export const ProjectJobRun$inboundSchema: z.ZodType<
  ProjectJobRun,
  z.ZodTypeDef,
  unknown
> = z.object({
...
> = z.object({
  ...
  authSession: z.lazy(() => JobSinkResultPayloadAuthSession$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  authSession: z.lazy(() => JobSinkResultPayloadAuthSession$outboundSchema)
    .optional(),
