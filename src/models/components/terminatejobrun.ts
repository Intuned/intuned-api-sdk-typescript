...
/** @internal */
export const TerminateJobRunMessage$inboundSchema: z.ZodNativeEnum<
  typeof TerminateJobRunMessage
> = z.nativeEnum(TerminateJobRunMessage);

/** @internal */
export const TerminateJobRunMessage$outboundSchema: z.ZodNativeEnum<
  typeof TerminateJobRunMessage
...
/** @internal */
export const TerminateJobRun$inboundSchema: z.ZodType<
  TerminateJobRun,
  z.ZodTypeDef,
  unknown
> = z.object({
