...
/** @internal */
export const QueueItem$inboundSchema: z.ZodType<QueueItem, z.ZodTypeDef, unknown> = z.object({
    apiName: z.string(),
...
/** @internal */
export const QueueItem$outboundSchema: z.ZodType<QueueItem$Outbound, z.ZodTypeDef, QueueItem> =
    z.object({
        apiName: z.string(),
