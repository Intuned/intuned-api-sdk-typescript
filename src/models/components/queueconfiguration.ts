...
export type QueueConfigurationSchedule = {
    pause: string;
    resume: string;
};
...
export type QueueConfiguration = {
    ...
    schedule?: QueueConfigurationSchedule | undefined;
...
/** @internal */
export namespace QueueConfigurationSchedule$ {
    export const inboundSchema: z.ZodType<QueueConfigurationSchedule, z.ZodTypeDef, unknown> = z
        .object({
            pause: z.string(),
            resume: z.string(),
        })
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, QueueConfigurationSchedule> = z
        .object({
            pause: z.string(),
            resume: z.string(),
        })
...
export namespace QueueConfiguration$ {
    export const inboundSchema: z.ZodType<QueueConfiguration, z.ZodTypeDef, unknown> = z
        .object({
            ...
            schedule: z.lazy(() => QueueConfigurationSchedule$.inboundSchema).optional(),
            randomWait: z
    ...
    export type Outbound = {
        ...
        schedule?: QueueConfigurationSchedule$.Outbound | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, QueueConfiguration> = z
        .object({
            ...
            schedule: z.lazy(() => QueueConfigurationSchedule$.outboundSchema).optional(),
            randomWait: z
