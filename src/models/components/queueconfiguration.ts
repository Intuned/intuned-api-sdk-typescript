 ...
 * The run mode of the queue. Currently, only `Default` is supported, which is first in first out.
 */
export type QueueConfigurationRunMode = ClosedEnum<
...
/** @internal */
export const RateLimits$inboundSchema: z.ZodType<
  RateLimits,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const RateLimits$outboundSchema: z.ZodType<
  RateLimits$Outbound,
  z.ZodTypeDef,
  RateLimits
> = z.object({
...
/** @internal */
export const MsFormattedRange$inboundSchema: z.ZodType<
  MsFormattedRange,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const MillisecondsRange$inboundSchema: z.ZodType<
  MillisecondsRange,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const RandomWait$inboundSchema: z.ZodType<
  RandomWait,
  z.ZodTypeDef,
  unknown
> = z.union([
...
/** @internal */
export type RandomWait$Outbound =
  | MillisecondsRange$Outbound
  | MsFormattedRange$Outbound;

/** @internal */
export const RandomWait$outboundSchema: z.ZodType<
  RandomWait$Outbound,
  z.ZodTypeDef,
  RandomWait
> = z.union([
