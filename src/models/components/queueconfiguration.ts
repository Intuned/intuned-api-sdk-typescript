...
export type RandomWait2 = {
    /**
     * The minimum duration to wait. An ms-formatted string.
     */
    min: string;
    /**
     * The maximuim duration to wait. An ms-formatted string.
     */
    max: string;
};

export type RandomWait1 = {
    /**
     * The miminum duration to wait in milliseconds.
     */
    min: number;
    /**
 ...
 */
export type RandomWait = RandomWait1 | RandomWait2;
...
export type QueueConfiguration = {
     ...
     * A random wait duration range added between executed items. The range can be in milliseconds or ms-formatted strings.
     */
    randomWait?: RandomWait1 | RandomWait2 | undefined;
};
...
/** @internal */
export namespace RandomWait2$ {
    export const inboundSchema: z.ZodType<RandomWait2, z.ZodTypeDef, unknown> = z.object({
        min: z.string(),
        max: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RandomWait2> = z.object({
        min: z.string(),
        max: z.string(),
    });
}
...
/** @internal */
export namespace RandomWait1$ {
    export const inboundSchema: z.ZodType<RandomWait1, z.ZodTypeDef, unknown> = z.object({
        min: z.number(),
        max: z.number(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RandomWait1> = z.object({
        min: z.number(),
        max: z.number(),
    });
}
...
export namespace RandomWait$ {
    export const inboundSchema: z.ZodType<RandomWait, z.ZodTypeDef, unknown> = z.union([
        z.lazy(() => RandomWait1$.inboundSchema),
        z.lazy(() => RandomWait2$.inboundSchema),
    ]);

    export type Outbound = RandomWait1$.Outbound | RandomWait2$.Outbound;
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RandomWait> = z.union([
        z.lazy(() => RandomWait1$.outboundSchema),
        z.lazy(() => RandomWait2$.outboundSchema),
    ]);
}
...
export namespace QueueConfiguration$ {
    ...
    export type Outbound = {
        ...
        randomWait?: RandomWait1$.Outbound | RandomWait2$.Outbound | undefined;
    };
