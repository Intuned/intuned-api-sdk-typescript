...
/** @internal */
export const RunMode$inboundSchema: z.ZodNativeEnum<typeof RunMode> = z
  .nativeEnum(RunMode);

/** @internal */
export const RunMode$outboundSchema: z.ZodNativeEnum<typeof RunMode> =
  RunMode$inboundSchema;
