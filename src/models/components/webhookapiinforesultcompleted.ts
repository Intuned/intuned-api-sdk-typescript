...
/** @internal */
export const WebhookAPIInfoResultCompletedStatus$outboundSchema:
  z.ZodNativeEnum<typeof WebhookAPIInfoResultCompletedStatus> =
...
export namespace WebhookAPIInfoResultCompletedStatus$ {
  ...
  export const outboundSchema =
    WebhookAPIInfoResultCompletedStatus$outboundSchema;
}
