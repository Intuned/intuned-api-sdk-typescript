...
export namespace QueueSinkResultPayloadAuthSession$ {
  ...
  export const outboundSchema =
    QueueSinkResultPayloadAuthSession$outboundSchema;
...
/** @internal */
export const ProjectQueue$inboundSchema: z.ZodType<
  ProjectQueue,
  z.ZodTypeDef,
  unknown
> = z.object({
...
> = z.object({
  ...
  authSession: z.lazy(() => QueueSinkResultPayloadAuthSession$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  authSession: z.lazy(() => QueueSinkResultPayloadAuthSession$outboundSchema)
    .optional(),
