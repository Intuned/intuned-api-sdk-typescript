...
/** @internal */
export const WebhookSinkType$inboundSchema: z.ZodNativeEnum<
  typeof WebhookSinkType
> = z.nativeEnum(WebhookSinkType);

/** @internal */
export const WebhookSinkType$outboundSchema: z.ZodNativeEnum<
  typeof WebhookSinkType
...
/** @internal */
export const WebhookSink$inboundSchema: z.ZodType<
  WebhookSink,
  z.ZodTypeDef,
  unknown
> = z.object({
