...
/** @internal */
export const AuthSessionCreateRequestedMoreInfoResultStatus$inboundSchema:
  z.ZodNativeEnum<typeof AuthSessionCreateRequestedMoreInfoResultStatus> = z
    .nativeEnum(AuthSessionCreateRequestedMoreInfoResultStatus);

/** @internal */
export const AuthSessionCreateRequestedMoreInfoResultStatus$outboundSchema:
  z.ZodNativeEnum<typeof AuthSessionCreateRequestedMoreInfoResultStatus> =
...
export namespace AuthSessionCreateRequestedMoreInfoResultStatus$ {
  ...
  export const outboundSchema =
    AuthSessionCreateRequestedMoreInfoResultStatus$outboundSchema;
}

/** @internal */
export const DetailsRequestType$inboundSchema: z.ZodNativeEnum<
  typeof DetailsRequestType
> = z.nativeEnum(DetailsRequestType);

/** @internal */
export const DetailsRequestType$outboundSchema: z.ZodNativeEnum<
  typeof DetailsRequestType
...
/** @internal */
export const DetailsAction$inboundSchema: z.ZodNativeEnum<
  typeof DetailsAction
> = z.nativeEnum(DetailsAction);

/** @internal */
export const DetailsAction$outboundSchema: z.ZodNativeEnum<
  typeof DetailsAction
...
/** @internal */
export const MultipleChoice$inboundSchema: z.ZodType<
  MultipleChoice,
  z.ZodTypeDef,
  unknown
> = z.object({
