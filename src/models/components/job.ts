...
/** @internal */
export const JobStateStatus$inboundSchema: z.ZodNativeEnum<
  typeof JobStateStatus
> = z.nativeEnum(JobStateStatus);

/** @internal */
export const JobStateStatus$outboundSchema: z.ZodNativeEnum<
  typeof JobStateStatus
...
/** @internal */
export const Paused$inboundSchema: z.ZodType<Paused, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const Paused$outboundSchema: z.ZodType<
  Paused$Outbound,
  z.ZodTypeDef,
  Paused
> = z.object({
...
/** @internal */
export const StateStatus$inboundSchema: z.ZodNativeEnum<typeof StateStatus> = z
  .nativeEnum(StateStatus);
