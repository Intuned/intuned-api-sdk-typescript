...
export namespace WebhookAPIInfoResultFailedStatus$ {
    export const inboundSchema: z.ZodNativeEnum<typeof WebhookAPIInfoResultFailedStatus> =
        z.nativeEnum(WebhookAPIInfoResultFailedStatus);
    export const outboundSchema: z.ZodNativeEnum<typeof WebhookAPIInfoResultFailedStatus> =
        inboundSchema;
}
