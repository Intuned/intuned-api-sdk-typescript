...
/** @internal */
export const FileSource$inboundSchema: z.ZodType<FileSource, z.ZodTypeDef, unknown> = z.union([
...
/** @internal */
export const FileSource$outboundSchema: z.ZodType<FileSource$Outbound, z.ZodTypeDef, FileSource> =
    z.union([
