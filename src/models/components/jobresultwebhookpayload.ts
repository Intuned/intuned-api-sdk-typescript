 ...
 */
export type JobResultWebhookPayloadAuthSession = {
    /**
 ...
 */
export type JobResultWebhookPayload = {
    /**
     * Webhook API info
     */
     ...
     * The auth session used in the run
     */
    authSession?: JobResultWebhookPayloadAuthSession | undefined;
    /**
     * The job details of the run
     */
...
/** @internal */
export namespace JobResultWebhookPayloadAuthSession$ {
...
/** @internal */
export namespace JobResultWebhookPayload$ {
    export const inboundSchema: z.ZodType<JobResultWebhookPayload, z.ZodTypeDef, unknown> =
        z.object({
            apiInfo: WebhookAPIInfo$.inboundSchema,
            workspaceId: z.string(),
            project: z.lazy(() => Project$.inboundSchema),
            authSession: z.lazy(() => JobResultWebhookPayloadAuthSession$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        authSession?: JobResultWebhookPayloadAuthSession$.Outbound | undefined;
        projectJob: ProjectJob$.Outbound;
        projectJobRun: ProjectJobRun$.Outbound;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, JobResultWebhookPayload> =
        z.object({
            apiInfo: WebhookAPIInfo$.outboundSchema,
            workspaceId: z.string(),
            project: z.lazy(() => Project$.outboundSchema),
            authSession: z
                .lazy(() => JobResultWebhookPayloadAuthSession$.outboundSchema)
                .optional(),
