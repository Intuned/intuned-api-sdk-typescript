...
export namespace StructuredDataExtractionSyncResponse$ {
    ...
    export const inboundSchema = StructuredDataExtractionSyncResponse$inboundSchema;
    /** @deprecated use `StructuredDataExtractionSyncResponse$outboundSchema` instead. */
    export const outboundSchema = StructuredDataExtractionSyncResponse$outboundSchema;
