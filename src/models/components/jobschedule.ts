...
/** @internal */
export const Every$inboundSchema: z.ZodType<Every, z.ZodTypeDef, unknown> = z.union([
    z.number(),
    z.string(),
]);
...
/** @internal */
export const Every$outboundSchema: z.ZodType<Every$Outbound, z.ZodTypeDef, Every> = z.union([
    z.number(),
    z.string(),
]);
...
/** @internal */
export const Intervals$inboundSchema: z.ZodType<Intervals, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Intervals$outboundSchema: z.ZodType<Intervals$Outbound, z.ZodTypeDef, Intervals> =
    z.object({
        every: z.union([z.number(), z.string()]),
    });
...
/** @internal */
export const Calendars$inboundSchema: z.ZodType<Calendars, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Calendars$outboundSchema: z.ZodType<Calendars$Outbound, z.ZodTypeDef, Calendars> =
    z.object({
...
/** @internal */
export const JobSchedule$inboundSchema: z.ZodType<JobSchedule, z.ZodTypeDef, unknown> = z.object({
