...
/** @internal */
export const AmazonS3SinkType$inboundSchema: z.ZodNativeEnum<
  typeof AmazonS3SinkType
> = z.nativeEnum(AmazonS3SinkType);

/** @internal */
export const AmazonS3SinkType$outboundSchema: z.ZodNativeEnum<
  typeof AmazonS3SinkType
...
/** @internal */
export const AmazonS3Sink$inboundSchema: z.ZodType<
  AmazonS3Sink,
  z.ZodTypeDef,
  unknown
> = z.object({
