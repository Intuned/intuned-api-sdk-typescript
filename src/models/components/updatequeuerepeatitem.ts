...
export namespace UpdateQueueRepeatItemMessage$ {
    export const inboundSchema: z.ZodNativeEnum<typeof UpdateQueueRepeatItemMessage> = z.nativeEnum(
        UpdateQueueRepeatItemMessage
    );
    export const outboundSchema: z.ZodNativeEnum<typeof UpdateQueueRepeatItemMessage> =
        inboundSchema;
}
