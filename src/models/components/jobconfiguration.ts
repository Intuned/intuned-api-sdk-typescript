...
export namespace JobConfiguration$ {
    export const inboundSchema: z.ZodType<JobConfiguration, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, JobConfiguration> = z
        .object({
