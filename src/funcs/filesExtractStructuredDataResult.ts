 ...
 */
export async function filesExtractStructuredDataResult(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.FileExtractStructuredDataResultRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/{workspaceId}/files/extract/structuredData/{operationId}/result")(
        pathParams$
    );
