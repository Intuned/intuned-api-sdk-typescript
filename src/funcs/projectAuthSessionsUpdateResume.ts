 ...
 */
export async function projectAuthSessionsUpdateResume(
  ...
  >
> {
  const input$: operations.UpdateAuthSessionResumeRequest = {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateAuthSessionResumeRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.AuthSessionCreateResume, {
    explode: true,
  });
  ...
  const path$ = pathToFunc(
    "/{workspaceId}/projects/{projectName}/auth-sessions/update/{operationId}/resume",
  )(pathParams$);
  ...
  const context = {
    operationID: "updateAuthSessionResume",
    oAuth2Scopes: [],
