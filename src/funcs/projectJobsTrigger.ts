...
export function projectJobsTrigger(
  ...
  Result<
    operations.TriggerJobResponseBody,
    | errors.TriggerJobResponseBody
    | errors.TriggerJobProjectJobsResponseBody
    | errors.TriggerJobProjectJobsResponseResponseBody
    | IntunedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TriggerJobResponseBody$inboundSchema),
    M.jsonErr(400, errors.TriggerJobResponseBody$inboundSchema),
    M.jsonErr(401, errors.TriggerJobProjectJobsResponseBody$inboundSchema),
    M.jsonErr(
      404,
      errors.TriggerJobProjectJobsResponseResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
