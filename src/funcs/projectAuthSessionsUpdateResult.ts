 ...
 */
export async function projectAuthSessionsUpdateResult(
  ...
  >
> {
  const input$: operations.UpdateAuthSessionResultRequest = {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateAuthSessionResultRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc(
    "/{workspaceId}/projects/{projectName}/auth-sessions/update/{operationId}/result",
  )(pathParams$);
