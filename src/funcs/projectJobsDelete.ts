 ...
 * Deletes a job by ID.
 */
export function projectJobsDelete(
  ...
  Result<
    void,
    | errors.DeleteJobResponseBody
    | errors.DeleteJobProjectJobsResponseBody
    | IntunedClientError
...
> {
  ...
  >(
    M.nil(204, z.void()),
    M.jsonErr(401, errors.DeleteJobResponseBody$inboundSchema),
    M.jsonErr(404, errors.DeleteJobProjectJobsResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
