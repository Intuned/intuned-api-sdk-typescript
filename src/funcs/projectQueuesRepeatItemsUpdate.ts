 ...
 */
export async function projectQueuesRepeatItemsUpdate(
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateRepeatQueueItemRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.QueueRepeatItemInput, {
    explode: true,
  });
