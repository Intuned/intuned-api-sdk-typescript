...
export function projectJobsRunsAll(
  ...
  Result<
    operations.GetJobRunsResponseBody,
    | errors.GetJobRunsResponseBody
    | errors.GetJobRunsProjectJobsRunsResponseBody
    | errors.GetJobRunsProjectJobsRunsResponseResponseBody
    | IntunedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetJobRunsResponseBody$inboundSchema),
    M.jsonErr(400, errors.GetJobRunsResponseBody$inboundSchema),
    M.jsonErr(401, errors.GetJobRunsProjectJobsRunsResponseBody$inboundSchema),
    M.jsonErr(
      404,
      errors.GetJobRunsProjectJobsRunsResponseResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
