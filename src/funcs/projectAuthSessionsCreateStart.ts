 ...
 */
export async function projectAuthSessionsCreateStart(
  ...
  >
> {
  const input$: operations.CreateOrUpdateAuthSessionStartRequest = {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.CreateOrUpdateAuthSessionStartRequest$outboundSchema.parse(
        value$,
      ),
  ...
  const body$ = encodeJSON$("body", payload$.CreateAuthSessionRequest, {
    explode: true,
  });
