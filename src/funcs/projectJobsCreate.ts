...
export function projectJobsCreate(
  ...
  Result<
    operations.CreateJobResponseBody,
    | errors.CreateJobResponseBody
    | errors.CreateJobProjectJobsResponseBody
    | errors.CreateJobProjectJobsResponseResponseBody
    | IntunedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateJobResponseBody$inboundSchema),
    M.jsonErr(400, errors.CreateJobResponseBody$inboundSchema),
    M.jsonErr(401, errors.CreateJobProjectJobsResponseBody$inboundSchema),
    M.jsonErr(
      404,
      errors.CreateJobProjectJobsResponseResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
