...
export function projectJobsResume(
  ...
  Result<
    operations.ResumeJobResponseBody,
    | errors.ResumeJobResponseBody
    | errors.ResumeJobProjectJobsResponseBody
    | errors.ResumeJobProjectJobsResponseResponseBody
    | IntunedClientError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResumeJobResponseBody$inboundSchema),
    M.jsonErr(400, errors.ResumeJobResponseBody$inboundSchema),
    M.jsonErr(401, errors.ResumeJobProjectJobsResponseBody$inboundSchema),
    M.jsonErr(
      404,
      errors.ResumeJobProjectJobsResponseResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
