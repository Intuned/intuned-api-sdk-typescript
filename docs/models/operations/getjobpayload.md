...
```typescript
import { GetJobPayload } from "@intuned/client/models/operations";

let value: GetJobPayload = {
  parameters: {
    "param1": "value1",
    "param2": 42,
    "param3": true,
...
| `retry`                                                                                                     | [operations.GetJobProjectJobsRetry](../../models/operations/getjobprojectjobsretry.md)                      | :heavy_minus_sign:                                                                                          | Retry policy configurations in case of failure.                                                             | {<br/>"maximumAttempts": 3<br/>}                                                                            |
