...
```typescript
import { GetJobRunsSinkWebhookSinkConfiguration } from "@intuned/client/models/operations";

let value: GetJobRunsSinkWebhookSinkConfiguration = {
  type: "webhook",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [operations.GetJobRunsSinkType](../../models/operations/getjobrunssinktype.md)       | :heavy_check_mark:                                                                   | N/A                                                                                  |                                                                                      |
