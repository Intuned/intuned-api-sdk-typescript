...
```typescript
import { GetJobsPayload } from "@intuned/client/models/operations";

let value: GetJobsPayload = {
  parameters: {
    "param1": "value1",
    "param2": 42,
    "param3": true,
...
| `retry`                                                                                                     | [operations.GetJobsProjectJobsRetry](../../models/operations/getjobsprojectjobsretry.md)                    | :heavy_minus_sign:                                                                                          | Retry policy configurations in case of failure.                                                             | {<br/>"maximumAttempts": 3<br/>}                                                                            |
