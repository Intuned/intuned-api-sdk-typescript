...
```typescript
import { SinkWebhookSinkConfiguration } from "@intuned/client/models/operations";

let value: SinkWebhookSinkConfiguration = {
  type: "webhook",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [operations.CreateJobSinkType](../../models/operations/createjobsinktype.md)         | :heavy_check_mark:                                                                   | N/A                                                                                  |                                                                                      |
