...
```typescript
import { GetJobsSinkWebhookSinkConfiguration } from "@intuned/client/models/operations";

let value: GetJobsSinkWebhookSinkConfiguration = {
  type: "webhook",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [operations.GetJobsSinkType](../../models/operations/getjobssinktype.md)             | :heavy_check_mark:                                                                   | N/A                                                                                  |                                                                                      |
