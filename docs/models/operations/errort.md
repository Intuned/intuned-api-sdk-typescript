...
```typescript
import { ErrorT } from "@intuned/client/models/operations";
...
| `code`                                                             | [operations.Code](../../models/operations/code.md)                 | :heavy_minus_sign:                                                 | Optional error code for more specific error identification         | script-process-crashed                                             |
