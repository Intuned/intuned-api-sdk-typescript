...
```typescript
import { GetJobRunSinkWebhookSinkConfiguration } from "@intuned/client/models/operations";

let value: GetJobRunSinkWebhookSinkConfiguration = {
  type: "webhook",
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [operations.GetJobRunSinkType](../../models/operations/getjobrunsinktype.md)         | :heavy_check_mark:                                                                   | N/A                                                                                  |                                                                                      |
