# CreateAuthSessionResultResponseBodyCode
...
```typescript
import { CreateAuthSessionResultResponseBodyCode } from "@intuned/client/models/operations";

let value: CreateAuthSessionResultResponseBodyCode = "script-process-crashed";
```
