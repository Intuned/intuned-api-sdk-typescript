...
| `type`                                                                     | [operations.GetJobRunsType](../../models/operations/getjobrunstype.md)     | :heavy_check_mark:                                                         | Type of the job run                                                        | SCHEDULED                                                                  |
| `status`                                                                   | [operations.GetJobRunsStatus](../../models/operations/getjobrunsstatus.md) | :heavy_check_mark:                                                         | Current status of the job run                                              | SUCCESS                                                                    |
...
| `reason`                                                                   | [operations.GetJobRunsReason](../../models/operations/getjobrunsreason.md) | :heavy_minus_sign:                                                         | Reason for job run  state change, stored as JSONB                          |                                                                            |