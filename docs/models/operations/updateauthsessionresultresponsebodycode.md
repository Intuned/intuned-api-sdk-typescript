# UpdateAuthSessionResultResponseBodyCode
...
```typescript
import { UpdateAuthSessionResultResponseBodyCode } from "@intuned/client/models/operations";

let value: UpdateAuthSessionResultResponseBodyCode = "script-process-crashed";
```
