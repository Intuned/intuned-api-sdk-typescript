...
```typescript
import { UpdateJobPayload } from "@intuned/client/models/operations";

let value: UpdateJobPayload = {
  parameters: {
    "param1": "value1",
    "param2": 42,
    "param3": true,
...
| `retry`                                                                                                     | [operations.UpdateJobRetry](../../models/operations/updatejobretry.md)                                      | :heavy_minus_sign:                                                                                          | Retry policy configurations in case of failure.                                                             | {<br/>"maximumAttempts": 3<br/>}                                                                            |
