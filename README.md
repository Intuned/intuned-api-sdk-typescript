...
Intuned Client: Programmatically trigger automations, manage Jobs, and handle AuthSessions.
...
| ----------- | ------ | ---------------------------------------------------------------------------------------------------------- | -------------------- |
| workspaceId | string | Your workspace ID. [How to find it](/docs/03-how-to/manage/manage-workspace#how-to-get-your-workspace-id)? | INTUNED_WORKSPACE_ID |
